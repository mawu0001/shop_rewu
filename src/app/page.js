  ...
  return (
    ...
    <div className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-black">
        <h1 className="text 6xl md:text-6xl font-bold text-center mb-4">REWU</h1>
        <button className="bg-green text-saddle50 py-2 px-6 rounded-lg text-lg hover:bg-saddle100">Products</button>
      </div>
    </div>
