  ...
  return (
    <section>
      <div className="relative w-full h-screen">
        <Image
          src={heroImage}
          alt="Image with different products"
          width={1440}
          height={697}
          layout="intrinsic"
          objectFit="cover"
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-black">
          <h1 className="text 6xl md:text-6xl font-bold text-center mb-4 hidden md:block">
            REWU
          </h1>
          <Link href="/productsGallery">
            <button className="bg-green text-saddle50 py-2 px-4 rounded-3xl text-lg hover:bg-saddle100 hidden md:block">
              Products
            </button>
          </Link>
        </div>
